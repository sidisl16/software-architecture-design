...
public class App {
	 ...
	 * 
	 * - tying our code to a concrete class: make our application more fragile and
	 * less flexible
	 * 
	 * - in java -> if we program to an interface, our system will work for any
	 * class implementing that interface ( because of polymorphism )
	 * 
	 * 
	 ...
	 * 
	 * - we have to find the part in our code that will change -> separate it - WE
	 * MAY ENCAPSULATE OBJECT CREATION
	 * 
	 * We can do it with Factory Pattern !!!
	 *
	 */
	public static void main(String[] args) {
		Algorithm shortestPath = AlgorithmFactory.getInstance(AlgorithmFactory.SHORTEST_PATH);
		shortestPath.solve();

		Algorithm spanningTree = AlgorithmFactory.getInstance(AlgorithmFactory.SPANNING_TREE);
		spanningTree.solve();
	}
}
