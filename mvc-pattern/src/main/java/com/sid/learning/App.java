...
public class App {
	 ...
	 * Why is it good? if we want to add extra features it can be done very very
	 * easily !!!
	 * 
	 * - Model: represents an object or a class carrying data. It can also have
	 * logic to update controller if its data changes.
	 * 
	 * - Controller: acts on both model and view It controls the data flow into
