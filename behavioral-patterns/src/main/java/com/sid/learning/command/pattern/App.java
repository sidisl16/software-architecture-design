...
public class App {
	 ...
	 * 
	 * Good -> the object invoking the computation know nothing about the
	 * implementation
	 * 
	 ...
	 * about the command execution The invoker does not know anything about a
	 * concrete command, it knows only about command interface !!!
	 * 
	 * Client: The client decides which commands to execute at which points To
